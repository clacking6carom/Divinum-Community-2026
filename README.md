...
# 🎮 Divinum — Community Edition

**Divinum — standalone Community Edition for offline play**
...
Divinum is a fantasy action RPG in which players assume the role of a lesser deity shaping a mortal realm through divine powers, faith management, and conflicts with rival pantheons. This Community Edition is a self-contained package that includes the base game and all released DLC in a single offline version. No storefront or additional software is required — the build is ready to play immediately after installation.

Players who want a self-contained, offline installation of Divinum that runs without a storefront client.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1148130/cb129e3cd0210d3aa465f793759309a1c12594ee/ss_cb129e3cd0210d3aa465f793759309a1c12594ee.1920x1080.jpg?t=1788395075" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1148130/e5d0764933276cf77cb2ea10420e6dd8cb5298ee/ss_e5d0764933276cf77cb2ea10420e6dd8cb5298ee.1920x1080.jpg?t=1788395075" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1148130/b76382c1f2e4adde9f613b3ee617b5e6dccd61a5/ss_b76382c1f2e4adde9f613b3ee617b5e6dccd61a5.1920x1080.jpg?t=1788395075" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- **Interface:** English, French, German, Spanish, Polish, Russian, Portuguese-Brazil, Simplified Chinese, Japanese
- **Voiceover:** English, French, German, Russian, Japanese

---

## 📦 Package Features

- 📦 **All Content Included** — Base game plus every released DLC in one installation.
- 🔌 **Offline Play** — Single-player campaign runs fully offline after setup.
- 🌐 **Multiplayer Support** — LAN or direct connection supported for co-op sessions.
- 🗜️ **Lossless Packaging** — Game files compressed without quality loss, integrity verified.
- 🌍 **Multiple Languages** — Interface in nine languages with five localized voice tracks.
- ⚙️ **Simple Setup** — Installer handles required redistributables — no additional software required.
- 🎮 **Controller Ready** — Full gamepad support alongside keyboard and mouse controls.

- **Compression:** Lossless
- **Install Time:** ~12 minutes on SSD, ~30 on HDD
- **Recoding:** none
- **Selective Download:** Optional non-English voice packs and the HD texture pack can be skipped during installation.

---

## 📦 DLCs Included

- Divinum: Ashen Pantheon
- Divinum: Tide of Faith
- Divinum: Celestial Arsenal Pack
- Divinum: Original Soundtrack
...
| **Storage** | 45 GB available space | 45 GB on SSD |
| **Additional** | DirectX 12, keyboard and mouse | SSD storage, gamepad supported |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Divinum\Saved`
